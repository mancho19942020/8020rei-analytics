 ...
 * Design System button is only visible to platform contributors.
 */

const DESIGN_SYSTEM_AUTHORIZED_EMAILS: string[] = [
  'german@8020rei.com',
...
export function canAccessDesignSystem(email: string | null | undefined): boolean {
  ...
  return DESIGN_SYSTEM_AUTHORIZED_EMAILS.includes(email.toLowerCase());
}
