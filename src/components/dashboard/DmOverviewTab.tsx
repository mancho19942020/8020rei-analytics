    ...
    <div className="space-y-4">
      ...
      <div style={{ height: 380 }}>
        <Widget
          ...
          tooltip="Daily PCM cost (era-priced) alongside daily mail pieces, plus the current PCM account balance. Designed to surface days where sends spike but balance has not been topped up — the 'we spent 2K on a 200 top-up' pattern."
        >
