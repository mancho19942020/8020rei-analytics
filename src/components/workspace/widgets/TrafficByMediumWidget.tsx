/**
 * Traffic By Medium Widget
 *
 * Displays traffic breakdown by medium (organic, cpc, referral, etc.)
...
interface TrafficByMediumWidgetProps {
  data: TrafficByMediumData[];
}

// Custom color palette for traffic mediums
const COLORS = [
  'rgb(59, 130, 246)',   // blue
...
export function TrafficByMediumWidget({ data }: TrafficByMediumWidgetProps) {
